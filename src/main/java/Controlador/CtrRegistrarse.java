...
public class CtrRegistrarse implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (action.equals("Confirmar Perfil")) {
			try {
				if (!vista.getTextoCorreo().getText().equals("") && !vista.getTextoAlias().getText().equals("")
						&& !vista.getTextoApellido().getText().equals("")
						&& !vista.getTextoApellido2().getText().equals("")
						&& !vista.getTextoNombre().getText().equals("")
						&& !vista.getTextoContrasena().getText().equals("")) {
					if (bdd.buscarUsuario(vista.getTextoCorreo().getText()) == null) {
						if (vista.getTextoConfirmarContrasena().getText()
								.equals(vista.getTextoContrasena().getText())) {
							Usuario.nuevoUsuario(vista.getTextoNombre().getText(),
									...
									vista.getTextoContrasena().getText(), vista.getTextoFechaNacimiento().getText(),
									null);
